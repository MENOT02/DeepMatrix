...
#[derive(Debug)]
pub struct DeepMatrixProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DeepMatrixProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DeepMatrix processing");
    
    let mut processor = DeepMatrixProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DeepMatrixProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DeepMatrixProcessor::new(false);
